    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .fondo1.p-8.mb-0
        .row.justify-content-center.align-items-center.mb-0(data-aos="fade-left")
          .col-lg-12.col-12.position-relative
            ImagenInfografica.color-acento-botones.mb-5
              template(v-slot:imagen)
                figure
                  img(alt="" src="@/assets/curso/temas/tema1/infraestructura.svg")
      ...
      .row.justify-content-center.align-items-center(data-aos="fade-rigth")
        .col-lg-6.col-12
          acordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--neutral")
