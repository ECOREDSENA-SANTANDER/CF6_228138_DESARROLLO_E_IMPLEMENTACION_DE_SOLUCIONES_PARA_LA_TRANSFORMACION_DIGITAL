    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .row.justify-content-center.align-items-center(data-aos="fade-left")
        .col-lg-9.col-12.mb-0
          p Una infraestructura habitual de Tecnologías de la información (TI), está conformada por los dispositivos usuales de #[em hardware] y #[em software]: instalaciones, centros de datos, servidores, computadoras de escritorio de #[em hardware] de red y varios recursos de #[em software] de aplicaciones institucionales.
      ...
      .row(data-aos="fade-left").justify-content-center.align-items-center
        .col-lg-6.p-2
          .container.tarjeta.container-gris.p-2.p-md-4
            .row.justify-content-center.align-items-center 
              .col-lg-4.col-5.p-2
                img(src="@/assets/curso/temas/tema1/p1.png")
              .col-lg-8
                h5.text-white.relleno-rojo.p-2 Infraestructura de #[em hardware]
                p Con infraestructura de #[em hardware], se está haciendo referencia a todos los equipos físicos necesarios para poner en marcha la solución. Ejemplo: computadores, servidores, portátiles, impresoras, escáneres, entre otros dispositivos físicos.
        
        .col-lg-6.p-2
          .container.tarjeta.container-gris.p-2.p-md-4
            .row.justify-content-center.align-items-center
              .col-lg-4.col-5.p-2
                img(src="@/assets/curso/temas/tema1/p2.png")
              .col-lg-8
                h5.text-white.relleno-rojo.p-2 Infraestructura de #[em software]
                p Una infraestructura de #[em software] se utiliza para almacenar, operar y tramitar las acciones necesarias dentro de una organización, basado en las tecnologías de la información.
      
      p.p-4 Entre los tipos de #[em hardware], se pueden mencionar los siguientes:
          ...
          acordionA.mb-3(tipo="b" clase-tarjeta="tarjeta gris-claro")
            div(titulo=" Procesamiento")
              .row(data-aos="fade-rigth")
                .col-md-9
                  p Se encarga de ejecutar instrucciones que se dan desde el mismo #[em software] del dispositivo.
                .col-md-2.col-3.py-2
      ...
      p.p-4 Por su parte, las estructuras de #[em software] también tienen algunas características y componentes específicos, como son:

      .row.justify-content-center(data-aos="fade-center")
        .col-lg-2.col-12.d-flex
          .px-lg-2.py-lg-3.px-3.mb-lg-0.mb-3.w-100.tarjeta1.p-3.clase1
            img.mb-5.m-auto(style="width: 85px" alt="" src="@/assets/curso/temas/tema1/img16.svg")
            h4.mb-4.text-center Corrección
                p.mb-0 <br>Que cumpla con su objetivo.
                .row.justify-content-center(data-aos="fade-center")
        .col-lg-2.col-12.d-flex
          .px-lg-2.py-lg-3.px-3.mb-lg-0.mb-3.w-100.tarjeta1.p-3.clase1
            img.mb-5.m-auto(style="width: 85px" alt="" src="@/assets/curso/temas/tema1/img17.svg")
            h4.mb-4.text-center Usabilidad
                p.mb-0 <br>Que sea fácil de aprender.
                .row.justify-content-center(data-aos="fade-center")
        .col-lg-2.col-12.d-flex
          .px-lg-2.py-lg-3.px-3.mb-lg-0.mb-3.w-100.tarjeta1.p-3.clase1
            img.mb-5.m-auto(style="width: 85px" alt="" src="@/assets/curso/temas/tema1/img18.svg")
            h4.mb-4.text-center Seguridad
                p.mb-0 <br>Que sea resistente a ataques externos.
                .row.justify-content-center(data-aos="fade-center")
        .col-lg-2.col-12.d-flex
          .px-lg-2.py-lg-3.px-3.mb-lg-0.mb-3.w-100.tarjeta1.p-3.clase1
            img.mb-5.m-auto(style="width: 85px" alt="" src="@/assets/curso/temas/tema1/img19.svg")
            h4.mb-4.text-center Flexibilidad
                p.mb-0 <br>Que pueda ser reformado por los desarrolladores.
                .row.justify-content-center(data-aos="fade-center")
        .col-lg-2.col-12.d-flex
          .px-lg-2.py-lg-3.px-3.mb-lg-0.mb-3.w-100.tarjeta1.p-3.clase1
            img.mb-5.m-auto(style="width: 85px" alt="" src="@/assets/curso/temas/tema1/img20.svg")
      ...
      .row.justify-content-center.align-items-center(data-aos="fade-right")
        ...
        SlyderA(tipo="b").fondo-banner.p-4
          .row.justify-content-center.p-4
            .col-lg-5.col-10
              h5 Grupo 1: #[em softwares] de Aplicación.
          ...
          .row.justify-content-center.p-4
            .col-lg-5.col-10
              h5 Grupo 1: #[em softwares] de gestión.
          ...
          .row.justify-content-center.p-4
            .col-lg-5.col-10
              h5 #[em softwares] de programación
          ...
          .row.justify-content-center.p-4
            .col-lg-5.col-10
              h5 #[em softwares] por tipo de licencia.
          ...
          .row.justify-content-center.p-4
            .col-lg-5.col-10
              h5  #[em software on premese] y #[em software] en la nube.
        ...
        .col-lg-4.col-12.d-flex
          .px-lg-4.py-lg-5.px-3.mb-lg-0.mb-3.w-100.tarjeta2.p-3.clase1
            ...
            h4.mb-4.text-center Requerimientos técnicos
             p.mb-0 <br>Los requerimientos técnicos y de componentes que integran la máquina, aumentan frecuentemente según las características que requiera el #[em software] para su correcto y óptimo funcionamiento.
        ...
        .col-lg-4.col-12.d-flex
          .px-lg-4.py-lg-5.px-3.mb-lg-0.mb-3.w-100.tarjeta2.p-3.clase1
            ...
            h4.mb-4.text-center Compensación de necesidades 
             p.mb-0 <br>La escalabilidad en el #[em software] es el incremento de un sistema para compensar las necesidades empresariales.    
      ...
      .fondo1.p-4.mb-0
        ...
        .col-lg-17.col-22
          p En el siguiente vídeo, se muestran en detalle, generalidades y elementos orientadores sobre las licencias de #[em software]. Se debe observar con atención y llevar registro de lo más destacado en la libreta personal de apuntes:
      ...
      .row.justify-content-center.align-items-center.mb-5(data-aos="fade-right")
        .col-lg-6.col-9
          ...
          p.mb-lg-0.mb-3 Dentro de los componentes de la ingeniería del #[em software], el ciclo de vida del #[em software] examina las fases necesarias para validar el desarrollo del mismo y así garantizar que este desempeñe los requerimientos para la aplicación y verificación de los procedimientos de desarrollo.
